...
def buy_passiv():
  ...
  if not getenv('USER_EMAIL') or not getenv('USER_PASSWORD') or not getenv('TOTP_SECRET'):
    raise Exception('Please provide USER_EMAIL, USER_PASSWORD, and TOTP_SECRET in .env.production file')
  user = {
